all:
	...
	i686-elf-gcc -ffreestanding -fno-builtin -nostdlib -T src/linker.ld -o bin/kernel.elf bin/kernel_entry.o bin/kernel.o bin/screen_services.o bin/stdlib.o bin/IDT_handlers.o bin/string.o bin/IDT_handler_stub.o bin/io.o bin/pic.o
